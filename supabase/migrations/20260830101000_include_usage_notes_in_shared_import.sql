-- Keep shared imports aligned with the current public.words contract.
    ...
    INSERT INTO public.words (
      ...
      CASE
        WHEN jsonb_typeof(v_word_record->'usage_notes') = 'object'
          THEN v_word_record->'usage_notes'
        ELSE NULL
      END,
      1,
      0,
...
COMMENT ON FUNCTION private.import_words_to_collection IS
  'Imports shared words, including usage notes, with case-insensitive uniqueness among active rows.';
