-- Migration: Make shared import conflict-safe for semantic uniqueness
-- Description: Avoid 23505 errors on idx_words_semantic_unique during import_words_to_collection
...
'Private SECURITY DEFINER function that bypasses RLS and safely handles semantic duplicates using ON CONFLICT on idx_words_semantic_unique key.';

COMMENT ON FUNCTION public.import_words_to_collection IS
'Public wrapper for importing words from shared collections. Semantic duplicates are skipped without raising 23505.';
