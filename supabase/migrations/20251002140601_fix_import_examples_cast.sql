-- Migration: Fix Import Examples Casting
-- Description: Fix JSONB to JSONB[] casting for examples field
...
-- ============================================================================
-- RECREATE PRIVATE FUNCTION WITH FIXED EXAMPLES HANDLING
-- ============================================================================
...
'Private SECURITY DEFINER function that bypasses RLS to import words. Verifies collection ownership. Fixed examples array handling.';
