-- Migration: Fix Import Conjugation Check
-- Description: Ensure conjugation is NULL for non-verbs to satisfy check constraint
...
-- ============================================================================
-- RECREATE PRIVATE FUNCTION WITH FIXED CONJUGATION HANDLING
-- ============================================================================
...
BEGIN
    ...
    -- Ensure p_words is treated as an array
    ...
    LOOP
        -- Handle examples array conversion
        ...
        -- Handle conjugation: only for verbs
        v_part_of_speech := v_word_record->>'part_of_speech';
...
'Private SECURITY DEFINER function that bypasses RLS to import words. Verifies collection ownership. Only sets conjugation for verbs to satisfy check constraint.';
